...
static const char *DebugVert =
    ...
    "void main(void)\n"
    "{\n"
    "    // 直接使用内建的 gl_ModelViewProjectionMatrix\n"
...
static const char FrgShaderProjectNV12Texture[] = ""
        ...
        "    float y, u, v;                                                          \n"
        "    y = texture(u_textureY, vec2(tex.s, tex.t)).r;                          \n"
        "    vec2 colorUV = texture(u_textureUV, vec2(tex.s, tex.t)).rg;             \n"
        "    u = colorUV.x-0.5;                                                      \n"
        "    v = colorUV.y-0.5;                                                      \n"
        "    y = 1.1643*(y-0.0625);                                                  \n"
        ...
        "    fragColor = textureColor;//vec4(texcoord,0,1);//textureColor;                                               \n"
        "}                                                                           \n";


#if 0 // orginal ES Version
static const char VtxShaderProjectNV12Texture[] = ""
